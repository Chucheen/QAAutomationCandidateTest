...
class OrderLinesControllerTest < ActionController::TestCase
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post :create, order_line: { order_id: @order_line.order_id, product_id: @order_line.product_id, qty: @order_line.qty, total_price: @order_line.total_price, unit_price: @order_line.unit_price }
    end
  ...
  test "should update order_line" do
    patch :update, id: @order_line, order_line: { order_id: @order_line.order_id, product_id: @order_line.product_id, qty: @order_line.qty, total_price: @order_line.total_price, unit_price: @order_line.unit_price }
    assert_redirected_to order_line_path(assigns(:order_line))
  end
